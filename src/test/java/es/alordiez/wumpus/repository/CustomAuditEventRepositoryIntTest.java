...
import es.alordiez.wumpus.config.audit.AuditEventConverter;
import es.alordiez.wumpus.domain.PersistentAuditEvent;
...
import static es.alordiez.wumpus.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
