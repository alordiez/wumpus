...
import es.alordiez.wumpus.config.Constants;
import es.alordiez.wumpus.WumpusJhApp;
import es.alordiez.wumpus.domain.Authority;
import es.alordiez.wumpus.domain.PersistentToken;
import es.alordiez.wumpus.domain.User;
import es.alordiez.wumpus.repository.AuthorityRepository;
import es.alordiez.wumpus.repository.PersistentTokenRepository;
import es.alordiez.wumpus.repository.UserRepository;
import es.alordiez.wumpus.security.AuthoritiesConstants;
import es.alordiez.wumpus.service.MailService;
import es.alordiez.wumpus.service.dto.UserDTO;
import es.alordiez.wumpus.service.dto.PasswordChangeDTO;
import es.alordiez.wumpus.web.rest.errors.ExceptionTranslator;
import es.alordiez.wumpus.web.rest.vm.KeyAndPasswordVM;
import es.alordiez.wumpus.web.rest.vm.ManagedUserVM;
import es.alordiez.wumpus.service.UserService;
