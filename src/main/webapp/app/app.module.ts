...
import { WumpusJhCoreModule } from 'app/core';
import { WumpusJhAppRoutingModule } from './app-routing.module';
...
@NgModule({
    imports: [
        BrowserModule,
        WumpusJhAppRoutingModule,
        Ng2Webstorage.forRoot({ prefix: 'jhi', separator: '-' }),
        WumpusJhSharedModule,
        WumpusJhCoreModule,
        WumpusJhHomeModule,
...
export class WumpusJhAppModule {}
